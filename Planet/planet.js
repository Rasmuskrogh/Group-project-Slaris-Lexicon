...
window.addEventListener("load", () => {
  ...
  document.querySelector(".favorite__button").addEventListener("click", (e) => {
...
const setFavoriteButton = (favorites, planet) => {
  if (favorites.includes(planet)) {
    document.querySelector(".favorite__button").innerText = "Remove Favorite";
  } else {
